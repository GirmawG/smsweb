...
<div class="span6">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form action="save_access.php" method="POST" name="save" class="form" onsubmit="return validateAddress();" class="form-horizontal">
                ...
                <div class="controls">
                    <select name="user" class="form-control">
                        <?php foreach($resultuser as $res){
                            echo "<option value='".$res['id']."'>".$res['full_name']."</option>";
                        }?>
                    </select>                                                                                                                                                                                       
                ...
                <div class="controls">                                                                                                                              
                    <select name="access" class="form-control">                                                                                                                                                                                                                                    
                        <?php foreach($resultsms as $res){
                            echo "<option value='".$res['id']."'>".$res['access_right']."</option>";
                        }?>
                    </select>
