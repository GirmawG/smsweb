...
<div class="span6">
        ...
        <table class="table table-bordered data-table">
          ...
          $user_id=$_SESSION['ind'];               
            $dtt='';
                $counter = 1;
                $result = $follw->getData("SELECT * FROM message where sender = 7000 order by id DESC;");
        ...
        { 
          if($dtt != substr($res['td'],0,10) ){           
              echo " <tr>
                          ...
                          <td>" . $res['receiver'] . "</td>
                          <td>" .substr(str_replace("+"," ",$res['text']),0,50) . "</td>
                        <td >
